...
export default function LeagueDetails() {
  ...
  if (isError) return <p>Error loading league badge</p>;
  if (!seasons?.length) return <p>No seasons found</p>;
  ...
  return (
    <div className="h-screen flex flex-col">
            ...
            <div className="w-72 h-48">
              ...
              {mainImageError && (
                <div className="w-full h-full bg-gray-100 flex items-center justify-center rounded">
                  <span className="text-gray-400">No Badge Available</span>
                </div>
              )}
              ...
              {selectedSeason?.strBadge && !mainImageError && (
                <img
                  ...
                  alt={`Season ${selectedSeason.strSeason} Badge`}
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="container mx-auto p-4">
          <h3 className="text-lg font-medium mb-4">All Seasons</h3>
